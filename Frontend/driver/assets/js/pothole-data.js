/**
 * RoadSafe AI — Shared Pothole Data Store (pothole-data.js)
 */
...
const PotholeDataStore = {
  ...
  getPotholeById(id) {
    if (!id) return this.potholes[0];
    return this.potholes.find((p) => p.id.toLowerCase() === id.toLowerCase()) || this.potholes[0];
  },

  getSeverityBadgeClass(severity) {
    if (!severity) return "badge-danger";
